...
#define			SHT20_Get_Temp				0x1600		//温湿度-获取温度
#define			SHT20_Get_Humi				0x1610		//温湿度-获取湿度
#define			SHT20_Get_Light				0x1620		//温湿度-获取光照强度
#define			SHT20_Get_All					0x1630		//温湿度-获取全部数据
...
#define			HF_RFID_Get_ID				0x1800		//HF_RFID-获取卡号
#define			HF_RFID_Get_Block			0x1810		//HF_RFID-获取块数据
#define			HF_RFID_Get_All				0x1820		//HF_RFID-获取卡号+块数据

#define			Gyr_Angle							0x1901		//陀螺仪-角度
#define			Gyr_Get_Angle					0x1900		//陀螺仪-获取角度

#define			PIR_State							0x1A01		//人体红外-是否检测到人体
#define			PIR_Get_State					0x1A00		//人体红外-获取是否检测到人体

#define			GPS_Location					0x1E01		//GPS-位置数据(经纬度)
#define			GPS_Get_Location			0x1E00		//GPS-获取位置数据(经纬度)

#define			Ultrasonic_Dis				0x2001		//超声波-距离(cm)
#define			Ultrasonic_Get_Dis		0x2000		//超声波-获取距离(cm)

#define			Motor_OFF							0x2100		//步进电机-关闭
#define			Motor_ON							0x2101		//步进电机-开启

#define			PM2_5_Conc						0x2201		//PM2.5-PM2.5浓度
#define			PM2_5_Get_Conc				0x2200		//PM2.5-获取PM2.5浓度

#define			Flame_State						0x2401		//火焰传感器-是否起火状态
#define			Flame_Get_State				0x2400		//火焰传感器-获取是否起火状态

#define			Shock_Count						0x2501		//震动-震动次数
#define			Shock_Get_Count				0x2500		//震动-获取震动次数

#define			Heart_Count						0x2601		//心率-每分钟心跳次数
#define			Heart_Get_Count				0x2600		//心率-获取每分钟心跳次数

#define			LF_RFID_ID						0x2701		//LF_RFID-卡号
#define			LF_RFID_Block					0x2711		//LF_RFID-块数据
#define			LF_RFID_All						0x2721		//LF_RFID-卡号+块数据
#define			LF_RFID_Get_ID				0x2700		//LF_RFID-获取卡号
#define			LF_RFID_Get_Block			0x2710		//LF_RFID-获取块数据
#define			LF_RFID_Get_All				0x2720		//LF_RFID-获取卡号+块数据

#define			A_P_Altitude					0x2801		//大气压力-海拔高度
#define			A_P_Get_Altitude			0x2800		//大气压力-获取海拔高度

#define			MP3_TO_MP3						0x2A00		//MP3-发送给MP3模块播放

#define			PH_State							0x2B01		//光电开关-开关状态
#define			PH_Get_State					0x2B00		//光电开关-获取开关状态

#define			Touch_Key_State				0x2C01		//触摸按键-按键状态
#define			Touch_Key_Get_State		0x2C00		//触摸按键-获取按键状态

#define			TF_Data								0x2D01		//TF卡-数据
#define			TF_Get_Data						0x2D00		//TF卡-获取数据
