...
extern void UART_PrintData(uint8 *pprompt,uint32 data);
extern void UART_PrintBuffer(uint8 *pprompt,uint8 *pdata,uint16 len);
extern void UART_PrintString(uint8 *pdata);

void UartInit(uint8 port,uint8 baud);
void HalUARTResetRxQueue(void);
/***************************************************************************************************
***************************************************************************************************/
