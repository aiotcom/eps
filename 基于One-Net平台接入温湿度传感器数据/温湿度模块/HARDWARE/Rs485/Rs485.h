...
#define			Addr_HF_RFID					0x18			//HF_RFID模块地址
...
#define			Addr_StepperMotor			0x21			//步进电机模块地址
...
#define			Addr_LF_RFID					0x27			//LF_RFID模块地址
#define			Addr_A_P							0x28			//大气压力模块地址
#define			Addr_LORA							0x29			//LORA模块地址
#define			Addr_MP3							0x2A			//MP3模块地址
#define			Addr_PH								0x2B			//光电开关模块地址
#define			Addr_Touch_Key				0x2C			//触摸按键模块地址
#define			Addr_TF								0x2D			//TF卡模块地址
#define			Addr_Alcohol					0x2E			//酒精传感器模块地址
#define			Addr_Formaldehyde			0x2F			//甲醛传感器模块地址
#define			Addr_Smoke						0x30			//烟雾传感器模块地址
#define			Addr_Color						0x31			//颜色传感器模块地址
#define			Addr_Noncontact_Temp	0x32			//非接触温度测量传感器模块地址
#define			Addr_Moisture					0x33			//土壤湿度传感器模块地址
#define			Addr_Gesture					0x34			//手势识别传感器模块地址
...
extern uint8_t DataHandling_485(uint8_t DesAddr);			//485数据处理
