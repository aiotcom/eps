...
// LEDs
#define HAL_BOARD_IO_LED_1_PORT        0   // Green************LED1  by boo
#define HAL_BOARD_IO_LED_1_PIN         2
#define HAL_BOARD_IO_LED_2_PORT        0   // Red**************LED2  by boo
#define HAL_BOARD_IO_LED_2_PIN         3
...
#else
#define HAL_BUTTON_1_PUSHED() (MCU_IO_GET(1,6))
#endif
