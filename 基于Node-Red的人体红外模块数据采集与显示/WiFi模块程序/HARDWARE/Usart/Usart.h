...
extern void USART2_IRQHand(void); 	//串口2服务函数
...
extern uint8_t PIR_Sta;																//人体红外状态
extern uint8_t Flame_Sta;															//火焰传感器状态
extern uint8_t Shock_Sta;															//震动传感器状态
extern uint8_t Smoke_Value;														//烟雾传感器数据(烟雾浓度百分比)
extern uint16_t A_P_Data;															//大气压力数据
extern uint16_t LDR_Data;															//光强数据
extern uint16_t PM2_5_Data;														//PM2.5数据
