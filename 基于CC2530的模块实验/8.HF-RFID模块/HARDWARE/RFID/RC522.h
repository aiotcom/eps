...
#define          macRC522_CS_Enable()         P1_4=0;
#define          macRC522_CS_Disable()        P1_4=1;

#define          macRC522_Reset_Enable()      P1_1=0;
#define          macRC522_Reset_Disable()     P1_1=1;

//#define          macRC522_LED_ON()            P1_5=0;
//#define          macRC522_LED_OFF()           P1_5=1;

#define          macRC522_SCK_0()             P1_5=0;
#define          macRC522_SCK_1()             P1_5=1;

#define          macRC522_MOSI_0()            P1_6=0;
#define          macRC522_MOSI_1()            P1_6=1;

#define          macRC522_MISO_GET()          P1_7
...
extern unsigned char ucArray_ID[ 10 ];
...
uint8 IC_Card_Search ( uint8 *pid);
