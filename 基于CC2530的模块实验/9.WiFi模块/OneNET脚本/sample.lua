...
function device_timer_init(dev)
	...
	-- 例如： --
	dev:timeout(3)
	dev:add(10,"dev1","\116\101\115\116\13\10")
	dev:add(10,"dev2","\116\101\115\116\13\10")
end
...
function device_data_analyze(dev)
	...
	-- 例如： --
	local s = dev:size()
	add_val(t,"Temp",a,dev:bytes(1,2)) 
	add_val(t,"Humi",a,dev:bytes(3,2))
	add_val(t,"Light",a,dev:bytes(5,4))
	dev:response()
	dev:send("bacheng\r\n")
