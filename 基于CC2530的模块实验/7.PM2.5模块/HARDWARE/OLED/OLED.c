...
//    OLED_P8x16Str(3,4,"www.stepiot.com");
    OLED_P6x8Str(53,1,"G P S");  
  
    OLED_P16x16Ch(5,2,5);   //经
    OLED_P16x16Ch(25,2,7);  //度
    OLED_P8x16Str(39,2,":");

    OLED_P16x16Ch(5,4,6);   //纬
    OLED_P16x16Ch(25,4,7);  //度
    OLED_P8x16Str(39,4,":");
    
    OLED_P16x16Ch(5,6,8);   //星
    OLED_P16x16Ch(25,6,9);  //数
    OLED_P8x16Str(39,6,":");
}
...
0x22,0x67,0x22,0x12,0x12,0x12,0x40,0x42,0x42,0x42,0x7E,0x42,0x42,0x42,0x40,0x00,/*"经",5*/

0x20,0x30,0xAC,0x63,0x20,0x18,0x00,0x08,0x48,0x48,0xFF,0x48,0x48,0x48,0x08,0x00,
0x22,0x67,0x22,0x12,0x12,0x12,0x00,0x02,0x02,0x02,0xFF,0x02,0x12,0x22,0x1E,0x00,/*"纬",6*/
